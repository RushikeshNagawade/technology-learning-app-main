...
class UpdateTrainee extends PureComponent {
    ...
    componentDidMount() {
        traineeservice.getTraineeByTid(this.state.tid).then((res) => {
            ...
            this.setState({ status: trainee.status, id: trainee.user.id });
                // fname: trainee.fname, lname: trainee.lname, phoneno: trainee.phoneno,
    ...
    UpdateTrainee = e => {
        ...
        let trainee = {  status: this.state.status, id: this.state.id}
            // fname: this.state.fname, lname: this.state.lname, phoneno: this.state.phoneno,
        ...
        traineeservice.updateTrainee(trainee, this.state.status,this.state.id).then((res) => {
                ...
                <div className="container">
                    <div className="row">
                        <div className=" center card " style ={{width: "40rem"}} >
                            <h3 className="text-center">Update Trainee</h3>
                                   ...
                                   {/* <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        <label>Location  &nbsp;&nbsp;&nbsp;&nbsp;
                                            ...
                                            {/* </form><select value={this.state.qualification} onChange={this.changeTraineeQualificationHandler} style ={{width: "400px"}}>
                                    ...
                                    <div className="form-group">
                                        <label>User id</label>
                                        <input placeholder="User id" className="form-control" name="jobSal"
