...
function Cards() {
  return (
    <div className='cards'>
      <h1> Get yourself registered and Check out these Grand Courses!</h1>
      <div className='cards__container'>
        <div className='cards__wrapper'>
          ...
          <ul className='cards__items'>
            ...
            />
            <CardItem
              src='C:\Users\shrut\react-homepage\src\images\html.png'
              text='
              ...
              label='HTML'
              // path='C:\Users\shrut\react-homepage\src\images\html.png'
            />
            <CardItem
